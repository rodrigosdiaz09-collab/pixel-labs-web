...
Versión actual: paleta marfil y azul petróleo del nuevo logo. Ver **LEEME-PALETA.md** para los cambios y cómo aplicarlos.

La guía de instalación que sigue es histórica; sus referencias a la paleta anterior y al logo placeholder fueron reemplazadas por esta actualización.

## Qué incluye

- `index.html`, `servicios.html`, `productos.html`, `nosotros.html`, `contacto.html` — las 5 páginas.
- `style.css` — estilos base.
- `theme-petroleo.css` — paleta actual marfil y petróleo, con tipografía sans-serif Jost.
